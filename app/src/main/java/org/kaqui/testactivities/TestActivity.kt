    ...
    override fun nextQuestion() {
        ...
        if (localTestType == testType) {
            ...
            val testFragment: Fragment =
                    when (testType) {
                        TestType.WORD_TO_READING, TestType.WORD_TO_MEANING, TestType.KANJI_TO_READING, TestType.KANJI_TO_MEANING, TestType.READING_TO_WORD, TestType.MEANING_TO_WORD, TestType.READING_TO_KANJI, TestType.MEANING_TO_KANJI, TestType.HIRAGANA_TO_ROMAJI, TestType.ROMAJI_TO_HIRAGANA, TestType.KATAKANA_TO_ROMAJI, TestType.ROMAJI_TO_KATAKANA, TestType.READING_TO_MEANING, TestType.MEANING_TO_READING -> QuizTestFragment.newInstance()
